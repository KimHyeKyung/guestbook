...
<body>
	<div id="wrap">
	<!-- <form action="/프로젝트명/패턴자리"> -->
	<form action="/guestbook/guestbook2" method="post">
	...
	<table width="100%" border=1>
		<tr>
			...
			<td width="50"><a href="/guestbook/guestbook2?a=deleteform&no=<%=vo.getNo()%>" style="text-decoration : none; color: gray;">삭제</a></td>
		</tr>
		<tr>
